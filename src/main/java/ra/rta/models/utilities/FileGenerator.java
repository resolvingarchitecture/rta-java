    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i1 = 0; i1 < numberOfCustomers; i1++) {
                String ucid = Generator.adid(partnerName, "" + i1);
                ...
                String uaid = Generator.adid("ksp", ucid + new Random().nextInt(1000));
                ...
                for(int k=0; k<2; k++) {
                    ...
                    switch (accountType) {
                        case 0: {
                            ...
                            uaid = Generator.adid(partnerName, ucid + new Random().nextInt(1000));
                            // Card Transactions
                        ...
                        case 3: {
                            ...
                            uaid = Generator.adid("ksp", ucid + new Random().nextInt(1000));
