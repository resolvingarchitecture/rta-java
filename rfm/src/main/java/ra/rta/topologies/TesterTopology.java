...
import ra.rta.Main;
import ra.rta.TransactionProcessingTopology;
import ra.rta.test.TesterBolt;
...
public class TesterTopology extends Main {
    ...
    protected final void buildTopology() {
        ...
        LOG.info("Building {}...", ra.rta.TesterTopology.class.getSimpleName());
        ...
        LOG.info(ra.rta.TesterTopology.class.getSimpleName() + " built.");
