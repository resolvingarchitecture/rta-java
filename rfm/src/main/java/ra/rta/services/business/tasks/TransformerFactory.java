...
public class TransformerFactory {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ra.rta.transform.TransformerFactory.class);
    ...
    public Transformer build(Event event) throws Exception {
        ...
        if(className==null) {
            ...
            ra.rta.transform.BaseTransformer transformer = (BaseTransformer)Class.forName("ra.rta.services.business.tasks."+className).getConstructor().newInstance();
