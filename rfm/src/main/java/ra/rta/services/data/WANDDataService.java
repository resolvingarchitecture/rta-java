...
public class WANDDataService extends BaseDataService {
	...
	public LinkedHashSet<RFMKPI> lookupTermcode(String description) {
		LinkedHashSet<RFMKPI> termcodes = new LinkedHashSet<>();
	...
	public ExactMatchFailure loadExactMatchFailure(String groupName, String tradeName) {
